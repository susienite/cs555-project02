    ...
    for fam in fam_data:
        ...
        for child_id in fam['Children']:
            ...
            if husb_data['Birthday'] != 'NA' and child_data['Birthday'] != 'NA':
                ...
                age_difference_husb = computeAgeDifferenceInYears(child_data['Birthday'], husb_data['Birthday'])
            ...
            if wife_data['Birthday'] != 'NA' and child_data['Birthday'] != 'NA':
                ...
                age_difference_wife = computeAgeDifferenceInYears(child_data['Birthday'], wife_data['Birthday'])
